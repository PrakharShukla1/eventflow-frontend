    ...
    <nav className="sticky top-0 z-50 bg-slate-950/60 backdrop-blur-3xl border-b border-white/10 shadow-[0_10px_30px_-10px_rgba(0,0,0,0.5)] selection:bg-cyan-500/30">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-20">
          ...
          {/* Navigation Links */}
          <div className="hidden md:flex items-stretch h-full gap-10">
            
            {/* 🌟 UPGRADED "LIVING" BROWSE EVENTS LINK 🌟 */}
            <Link to="/events" className="relative group flex items-center h-full px-2">
            ...
            {user && (
              <Link to="/my-bookings" className="relative group flex items-center h-full">
            ...
            {isAdmin && (
              <Link to="/admin" className="relative group flex items-center h-full">
                <span className={`text-sm font-bold tracking-wide transition-all duration-300 z-10 ${
          ...
          <div className="flex items-center gap-4">
            {user ? (
              <div className="flex items-center gap-5">
                <span className="hidden sm:flex items-center text-sm text-slate-400">
                  ...
                  {isAdmin && (
                    <span className="ml-3 px-3 py-1 rounded-full bg-fuchsia-500/10 border border-fuchsia-500/30 text-fuchsia-300 text-[10px] font-bold uppercase tracking-widest shadow-[0_0_10px_rgba(217,70,239,0.2)]">
                      Admin
                    </span>
                  )}
                </span>
                <button 
                  ...
                  className="py-2.5 px-5 text-sm font-bold rounded-xl bg-black/40 text-slate-300 hover:bg-slate-900 hover:text-cyan-300 transition-all duration-300 border border-white/10 hover:border-cyan-500/50 hover:shadow-[0_0_15px_rgba(34,211,238,0.2)]"
                >
                  Logout
                </button>
              </div>
              ...
              <div className="flex items-center gap-4">
                ...
                {/* Glowing Aura Button for Sign Up */}
                <div className="relative group hidden sm:block">
                  ...
                  <Link 
                    to="/register" 
                    className="relative block py-2.5 px-5 text-sm font-bold rounded-xl bg-slate-950 text-white border border-white/10 group-hover:bg-slate-900 group-hover:text-cyan-300 transition-all duration-300"
                  >
                    Sign Up
                  </Link>
                </div>
