...
const LoginPage = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-950 flex items-center justify-center px-4 relative overflow-hidden selection:bg-cyan-500/30">
      ...
      <div className="absolute top-[5%] left-[10%] w-[30rem] h-[30rem] bg-cyan-600/20 rounded-full blur-[150px] pointer-events-none animate-[pulse_6s_cubic-bezier(0.4,0,0.6,1)_infinite]"></div>
      <div className="absolute bottom-[5%] right-[10%] w-[30rem] h-[30rem] bg-fuchsia-600/20 rounded-full blur-[150px] pointer-events-none animate-[pulse_8s_cubic-bezier(0.4,0,0.6,1)_infinite]"></div>
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <div className="text-center mb-10">
          ...
          <p className="text-slate-400 text-lg font-light">Sign in to your EventFlow account</p>
        </div>
        ...
        <div className="relative bg-white/[0.02] backdrop-blur-3xl border border-white/10 shadow-[0_20px_50px_-15px_rgba(0,0,0,0.7)] rounded-[2.5rem] p-8 sm:p-10 overflow-hidden">
          ...
          <div className="relative z-10 bg-cyan-500/5 border border-cyan-500/20 rounded-2xl p-5 mb-8 text-sm text-cyan-200 shadow-[0_0_20px_rgba(34,211,238,0.1)] backdrop-blur-md">
            <p className="font-bold mb-2 flex items-center gap-2">
              <span className="animate-pulse">🔑</span> Demo credentials:
            </p>
            <p className="mb-1 font-mono text-cyan-100/80">Admin: admin@eventflow.com / admin123</p>
            <p className="font-mono text-cyan-100/80">User: rahul@example.com / user123</p>
          </div>
              ...
              >
                {loading ? (
                  <span className="flex items-center gap-2">
                    <span className="animate-spin h-5 w-5 border-2 border-white/20 border-t-white rounded-full"></span> Signing in...
                  </span>
                ) : (
                  'Sign In'
                )}
          ...
          <p className="relative z-10 text-center text-sm text-slate-400 mt-8 font-light">
            ...
            <Link to="/register" className="text-cyan-400 font-bold hover:text-cyan-300 transition-colors underline decoration-cyan-500/30 underline-offset-4">
              Sign up
            </Link>
          </p>
        </div>
